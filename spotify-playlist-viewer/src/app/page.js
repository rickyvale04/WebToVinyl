    ...
    <div className="min-h-screen bg-black text-white flex flex-col items-center">
      ...
      <main className="flex flex-col items-center justify-center flex-grow text-center px-4">
        ...
        <div className="w-full max-w-2xl bg-gray-900 p-8 rounded-lg shadow-lg border border-gray-700">
          ...
          {/* New simple button */}
          <button className="w-full bg-blue-600 text-white px-6 py-3 rounded-md text-lg font-bold hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 mb-6">
            Test Button
          </button>
